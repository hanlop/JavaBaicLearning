    ...
    public void addButtonEvent() {
        ...
        zuoButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (y0 == 3) {
                    System.out.println("0号图片在最右边,不能进行左移动");
                    return;
                }
                //2.交换0号图片和下方图片
                datas[x0][y0] = datas[x0][y0 + 1]; //用右边的图片,覆盖0号图片
                datas[x0][y0 + 1] = 0; //让右边的图片为0号图片
                y0 = y0 + 1; //修改索引
                //3.调用重绘的方法rePainView()
                rePainView();
            }
        ...
        xiaButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //1.边界处理,边界x0==0
                if (x0 == 0) {
                    System.out.println("0号图片在最上边,不能进行下移动");
                    return;
                }
                //2.交换0号图片和下方图片
                datas[x0][y0] = datas[x0 - 1][y0];
        ...
        youButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //1.边界处理,边界y0==0
                if (y0 == 0) {
                    System.out.println("0号图片在最左边,不能进行右移动");
                    return;
                }
                //2.交换0号图片和左方图片
                datas[x0][y0] = datas[x0][y0 - 1];
